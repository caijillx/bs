...
from faster_rcnn.network_files import det_utils
from faster_rcnn.network_files import boxes as box_ops
...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def forward(self,
        ...
        # 对于objectness 有5个元素，代表5个预测特征层
        # 每个特征层是一个tensor，一共有4个维度，第一维是batch_size，第二维是每个anchor对应预测的参数数量，第三维和第四维是feature map的高度和宽度
